...
const PortfolioShowcase: React.FC = () => {
  ...
  const categories: Category[] = [
    ...
    {
      id: "restaurants",
      name: "Restaurants & Hospitatlily",
      count: portfolioItems.filter((item) => item.category === "restaurants")
        .length,
    },
    {
      id: "professional",
      name: "Professional Services",
      count: portfolioItems.filter((item) => item.category === "professional")
        .length,
    },
    {
      id: "matterport",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Explore our collection of business photography that captures the
