  ...
  const galleryItems = [
    {
      ...
      description: "Stunning architectural photography showcasing clean lines and sophisticated design elements."
    },
    {
      id: 2,
      ...
      description: "Premium real estate photography capturing the essence of luxury living with breathtaking views."
    },
    {
      id: 3,
      ...
      description: "Dynamic automotive photography highlighting premium craftsmanship and performance aesthetics."
    },
    {
      id: 4,
      ...
      description: "Professional commercial spaces captured with cinematic quality and attention to brand identity."
    },
    {
      id: 5,
      ...
      category: "RV & Marine",
      title: "Luxury Yacht",
      description: "Marine photography that captures the elegance and adventure of luxury watercraft."
    },
    {
      id: 6,
      image: "/architecture-design_CYS.jpg",
      ...
      description: "Breathtaking drone footage providing unique perspectives that ground photography cannot achieve."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Every project tells a story. Here are some of our favorite visual narratives across luxury spaces.
          </p>
        </motion.div>
