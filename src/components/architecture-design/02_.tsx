...
const PortfolioShowcase: React.FC = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      id: "commercial",
      name: "Commercial",
      count: portfolioItems.filter((item) => item.category === "commercial")
        .length,
    },
    {
      id: "institutional",
      name: "Institutional",
      count: portfolioItems.filter((item) => item.category === "institutional")
        .length,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Explore our collection of architectural photography that captures
            the essence of design, structure, and spatial storytelling across
